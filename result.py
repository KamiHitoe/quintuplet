...
for img_path in img_path_list:
        ...
        faces=cascade.detectMultiScale(img, scaleFactor=1.2, minNeighbors=1, minSize=(68,68))
        Labels=["other", "ichika", "nino", "miku", "yotsuba", "itsuki"]
        ...
        if len(faces) > 0:
            for fp in faces:
                ...
                if Labels[score_argmax] == "yotsuba":
